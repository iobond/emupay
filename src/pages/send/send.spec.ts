  ...
  describe('Lifecycle Hooks', () => {
    ...
    describe('ionViewWillEnter', () => {
      it('should call get functions and subscribe to events', () => {
        ...
        const getAibWalletsListSpy = spyOn(instance, 'getAibWalletsList');
        instance.ionViewWillEnter();
        expect(profileProviderSpy).toHaveBeenCalledWith({ coin: Coin.BTC });
        expect(profileProviderSpy).toHaveBeenCalledWith({ coin: Coin.BCH });
        expect(profileProviderSpy).toHaveBeenCalledWith({ coin: Coin.AIB });
        expect(getAibWalletsListSpy).toHaveBeenCalled();
      });
    });
